 ...
 * @author Paul Shapiro
 */
public class BoilerpipeNodePlugin extends Plugin {
    // The shared instance.
    private static BoilerpipeNodePlugin plugin;

    /**
     * The constructor.
     */
    public BoilerpipeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BoilerpipeNodePlugin getDefault() {
        return plugin;
    }
